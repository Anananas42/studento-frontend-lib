...
export type AddEmployeeReducerActionType =
...
export interface IAddEmployeeReducerState {
    address: string;
    birthdate: string;
    city: string;
    class: string;
...
const initState:IAddEmployeeReducerState = {
    address: "",
    birthdate: "",
    city: "",
    class: "",
...
const addEmployeeReducer = (state: IAddEmployeeReducerState, action: AddEmployeeReducerActionType) => {
    switch (action.type) {
        case "SET_ADDRESS":
        {
...
const useAddEmployeeReducer = () => {
    return useReducer(addEmployeeReducer, initState);
}

export default useAddEmployeeReducer;